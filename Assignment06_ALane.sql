...
-- 2017-01-01,ALane,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_ALane')
	 Begin 
	  Alter Database [Assignment06DB_ALane] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_ALane;
	 End
	Create Database Assignment06DB_ALane;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_ALane;
...
CREATE VIEW dbo.vInventoriesByEmployeesByDates
  AS
	...
	MIN (CONCAT (e.EmployeeFirstName, ' ', e.EmployeeLastName)) AS Employee
...
/* Need to check my views to see all the columns i need
Select * From vCategories;
go
Select * From vProducts;
go
